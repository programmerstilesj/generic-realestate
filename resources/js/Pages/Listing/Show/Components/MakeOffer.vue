    ...
    <div>
      <form @submit.prevent="makeOffer">
        ...
        <input
          ...
          type="range" :min="minAcceptable" :max="maxAcceptable" step="10000"
...
const minAcceptable = computed(() => Math.round(props.price / 2))
const maxAcceptable = computed(()=> Math.round(props.price * 2))
